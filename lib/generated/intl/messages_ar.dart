...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "activateTrip":
            MessageLookupByLibrary.simpleMessage("تفعيل برنامج الرحلة"),
        "activeAccounts":
            MessageLookupByLibrary.simpleMessage("الحسابات المفعلة"),
        ...
        "addCardImage":
            MessageLookupByLibrary.simpleMessage("قم بإضافة صورة البطاقة"),
        "addImage": MessageLookupByLibrary.simpleMessage("إضافة صورة"),
        "addImagesTitle":
            MessageLookupByLibrary.simpleMessage("إضافة صور للرحلة"),
        "addNewAdvertisement":
            MessageLookupByLibrary.simpleMessage("إضافة إعلان جديد"),
        "addNewArticle":
            MessageLookupByLibrary.simpleMessage("إضافة مقالة جديدة"),
        "addNewEmployee":
        ...
        "add_about_btn":
            MessageLookupByLibrary.simpleMessage("إضافة معلومات الشركة"),
        "add_ad_btn": MessageLookupByLibrary.simpleMessage("إنشاء إعلان"),
        "add_new_article":
            MessageLookupByLibrary.simpleMessage("إضافة مقال جديد"),
        "add_new_question":
            MessageLookupByLibrary.simpleMessage("إضافة سؤال جديد"),
        "advertisementContent":
            MessageLookupByLibrary.simpleMessage("محتوي الإعلان"),
        "advertisementDisplayData":
            MessageLookupByLibrary.simpleMessage("بيانات عرض الإعلان :"),
        "advertisementImage":
            MessageLookupByLibrary.simpleMessage("صورة الإعلان"),
        "advertisementTitle":
        ...
        "articleDisplayData":
            MessageLookupByLibrary.simpleMessage("بيانات عرض المقال :"),
        ...
        "articleTitleShort":
            MessageLookupByLibrary.simpleMessage("عنوان المقال"),
        "articlesSection":
            MessageLookupByLibrary.simpleMessage("فقرة المقالات"),
        ...
        "bookingRequests":
            MessageLookupByLibrary.simpleMessage("طلبات حجز الرحلات"),
        "bookings": m0,
        "cancellationRate":
            MessageLookupByLibrary.simpleMessage("معدل إلغاء الحجوزات"),
        "card": MessageLookupByLibrary.simpleMessage("البطاقة"),
        "cardDescription":
            MessageLookupByLibrary.simpleMessage("وصف برنامج البطاقة :"),
        ...
        "completePayment":
            MessageLookupByLibrary.simpleMessage("إتمام دفع الحجز"),
        "confirmActivateTrip":
        ...
        "confirmDeleteArticle":
            MessageLookupByLibrary.simpleMessage("هل تريد حذف هذا المقال؟"),
        "confirmDeleteCard":
            MessageLookupByLibrary.simpleMessage("هل تريد حذف البطاقة"),
        ...
        "currentMonthImportGrowth": MessageLookupByLibrary.simpleMessage(
            "نسبة نمو الواردات للشهر الحالي"),
        "currentPassword":
        ...
        "displayedElements":
            MessageLookupByLibrary.simpleMessage("العناصر المعروضة"),
        "displayedItems":
            MessageLookupByLibrary.simpleMessage("العناصر المعروضة"),
        "editAboutItem":
            MessageLookupByLibrary.simpleMessage("تعديل بيانات العنصر"),
        "editAccountData":
        ...
        "editAdvertisementData":
            MessageLookupByLibrary.simpleMessage("تعديل بيانات الإعلان"),
        "editArticle":
            MessageLookupByLibrary.simpleMessage("تعديل بيانات المقالة"),
        "editArticleData":
            MessageLookupByLibrary.simpleMessage("تعديل بيانات المقالة"),
        "editEmployeeData":
            MessageLookupByLibrary.simpleMessage("تعديل بيانات الموظف"),
        "editItemData":
            MessageLookupByLibrary.simpleMessage("تعديل بيانات العنصر"),
        "editQuestion":
            MessageLookupByLibrary.simpleMessage("تعديل بيانات السؤال"),
        "editQuestionData":
            MessageLookupByLibrary.simpleMessage("تعديل بيانات السؤال"),
        "editTripData":
            MessageLookupByLibrary.simpleMessage("تعديل بيانات الرحلة"),
        "element": MessageLookupByLibrary.simpleMessage("عنصر"),
        "elementContent": MessageLookupByLibrary.simpleMessage("محتوي العنصر"),
        "elementDisplayData":
            MessageLookupByLibrary.simpleMessage("بيانات عرض العنصر :"),
        ...
        "faqSection":
            MessageLookupByLibrary.simpleMessage("فقرة الأسئلة الشائعة"),
        ...
        "inactiveAccounts":
            MessageLookupByLibrary.simpleMessage("الحسابات المعطلة"),
        "inactiveEmployee": MessageLookupByLibrary.simpleMessage("موظف موقوف"),
        "inquiry":
            MessageLookupByLibrary.simpleMessage("الاستفسار (الملاحظات)"),
        ...
        "login_title":
            MessageLookupByLibrary.simpleMessage("أهلا بك .. جاهز للمغامرة"),
        "logout": MessageLookupByLibrary.simpleMessage("تسجيل الخروج"),
        "logout_confirmation": MessageLookupByLibrary.simpleMessage(
            "هل ترغب في تسجيل الخروج من لوحة التحكم؟"),
        "manageAboutUs":
            MessageLookupByLibrary.simpleMessage("إدارة صفحة من نحن"),
        "manageAboutUsPage":
            MessageLookupByLibrary.simpleMessage("إدارة صفحة من نحن"),
        "manageAds": MessageLookupByLibrary.simpleMessage("إدارة الاعلانات"),
        "manageArticles":
            MessageLookupByLibrary.simpleMessage("إدارة المقالات"),
        "manageBookingRequests":
            MessageLookupByLibrary.simpleMessage("ادارة طلبات الحجز"),
        "manageFAQ":
            MessageLookupByLibrary.simpleMessage("إدارة الأسئلة الشائعة"),
        "manageSiteAdvertisement":
            MessageLookupByLibrary.simpleMessage("إدارة إعلان الموقع"),
        "manageSuspendedTrips":
            MessageLookupByLibrary.simpleMessage("ادارة الرحلات الموقوفة"),
        "manageTrips":
        ...
        "mustAddImages":
            MessageLookupByLibrary.simpleMessage("يجب إضافة صور للرحلة"),
        "newPassword":
            MessageLookupByLibrary.simpleMessage("كلمة المرور الجديدة"),
        "newUsersGrowthRate":
            MessageLookupByLibrary.simpleMessage("معدل زيادة المستخدمين الجدد"),
        ...
        "no_about_title":
            MessageLookupByLibrary.simpleMessage("لا توجد معلومات عن الشركة"),
        ...
        "no_ads_title":
            MessageLookupByLibrary.simpleMessage("لا توجد إعلانات بعد"),
        ...
        "no_articles_title":
            MessageLookupByLibrary.simpleMessage("لا توجد مقالات بعد"),
        ...
        "no_questions_title":
            MessageLookupByLibrary.simpleMessage("لا توجد أسئلة شائعة بعد"),
        ...
        "no_trips_title":
            MessageLookupByLibrary.simpleMessage("لا توجد رحلات حالياً"),
        "numberOfAdults": MessageLookupByLibrary.simpleMessage("عدد البالغين"),
        "numberOfArticles":
            MessageLookupByLibrary.simpleMessage("عدد المقالات في الموقع"),
        ...
        "programCards":
            MessageLookupByLibrary.simpleMessage("بطاقات البرنامج :"),
        "question": MessageLookupByLibrary.simpleMessage("السؤال"),
        "questionDisplayData":
            MessageLookupByLibrary.simpleMessage("بيانات عرض السؤال :"),
        ...
        "suspendedTrips":
            MessageLookupByLibrary.simpleMessage("الرحلات الموقوفة"),
        "title": MessageLookupByLibrary.simpleMessage("العنوان"),
        "todayNewBookings":
            MessageLookupByLibrary.simpleMessage("حجوزات جديدة لليوم"),
        ...
        "tripDuration":
            MessageLookupByLibrary.simpleMessage("مدة الرحلة (يوم)"),
        "tripEndPoint":
            MessageLookupByLibrary.simpleMessage("نقطة نهاية الرحلة"),
        ...
        "tripRegistrationDate":
            MessageLookupByLibrary.simpleMessage("تاريخ تسجيل الرحلة"),
        "tripStartPoint":
            MessageLookupByLibrary.simpleMessage("نقطة بداية الرحلة"),
        ...
        "unblockEmployee":
            MessageLookupByLibrary.simpleMessage("الغاء حظر الموظف"),
        "updateTripDetails":
            MessageLookupByLibrary.simpleMessage("تعديل تفاصيل الرحلة"),
        "uploadImagesHint":
            MessageLookupByLibrary.simpleMessage("قم بإضافة صور للرحلة"),
        "usersManagement":
            MessageLookupByLibrary.simpleMessage("متابعة المستخدمين"),
        ...
        "validation_price_required":
            MessageLookupByLibrary.simpleMessage("الرجاء إدخال سعر الرحلة"),
        "validation_required":
