...
Future<dynamic> updateAdsItemDialog(BuildContext context) {
  return showDialog(
    context: context,
    builder: (context) {
      return CustomDialog(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: prov.pickedImage == null
                      ? imageProviderNetwork(item.image)
          ...
          CustomButton(
            ...
            onPressed: () async {
              if (prov.formKey.currentState!.validate()) {
                ...
                await prov.updateAdsItem();

                //* close loading dialog
                Navigator.pop(context);

                if (prov.checkUpdatingAdsItem == true) {
                  Navigator.pop(context);

                  AppMessage.successBar(context, message: prov.message);
                } else if (prov.checkUpdatingAdsItem == false) {
